...
align: center
---
**Strict division into supervised classes can be tricky for continuous biological processes**. Adapted from Eulenberg, P., Köhler, N., Blasi, T. _et al_. Reconstructing cell cycle and disease progression using deep learning. _Nat Commun_ **8**, 463 (2017)
```
````
