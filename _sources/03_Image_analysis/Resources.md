...
```{list-table}
:header-rows: 1
:name: image-analysis-resource-table
...
* - 📖 Bioimage Data Analysis {cite}`Miura2016-wq`
...
* - 📄 Reproducible image handling and analysis {cite}`Miura2021-mb`
...
* - 🎥 iBiology Bioimage Analysis video series
  - [link](https://youtu.be/1xo4vi6Ub4I)
