...
align: center
---
**Strict division into supervised classes can be tricky for continuous biological processes**. Adapted from Eulenberg, P., Köhler, N., Blasi, T. _et al_. Reconstructing cell cycle and disease progression using deep learning. _Nat Commun_ **8**, 463 (2017){cite}``
```
````

```{dropdown} 📚🤷‍♀️ Where can I learn more?

* 📄 [Data-analysis strategies for image-based cell profiling](https://www.nature.com/articles/nmeth.4397){cite}``
* 📄 [Scoring diverse cellular morphologies in image-based screens with iterative feedback and machine learning](https://www.pnas.org/doi/10.1073/pnas.0808843106){cite}``
